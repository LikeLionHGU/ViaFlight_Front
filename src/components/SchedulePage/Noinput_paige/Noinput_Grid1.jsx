...
import picture6 from "../../../img/noinput_bg/6.png";
import picture7 from "../../../img/noinput_bg/7.png";
...
import picture13 from "../../../img/noinput_bg/13.png";
import picture14 from "../../../img/noinput_bg/14.png";
...
import picture20 from "../../../img/noinput_bg/20.png";
import picture21 from "../../../img/noinput_bg/21.png";
      ...
      <div className="no_input_Grid1">
        <Fadein>
          <div className="Bg-container">
            <img src={picture1} className="bg-img"></img>
            <img src={picture2} className="bg-img"></img>
            <img src={picture3} className="bg-img"></img>
            <img src={picture4} className="bg-img"></img>
            <img src={picture5} className="bg-img"></img>
          </div>
        </Fadein>

        <Fadein>
          <div className="Bg-container2">
            <img src={picture8} className="bg-img"></img>
            <img src={picture9} className="bg-img"></img>
            <img src={picture10} className="bg-img"></img>
            <img src={picture11} className="bg-img"></img>
            <img src={picture12} className="bg-img"></img>
          </div>
        </Fadein>

        <Fadein>
          <div className="Bg-container">
            <img src={picture15} className="bg-img"></img>
            <img src={picture16} className="bg-img"></img>
            <img src={picture17} className="bg-img"></img>
            <img src={picture18} className="bg-img"></img>
            <img src={picture19} className="bg-img"></img>
          </div>
        </Fadein>
      </div>
